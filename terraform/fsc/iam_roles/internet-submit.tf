...
resource "aws_iam_role_policy_attachment" "internet_submit_instance_role_cloudwatch_policy" {
...
resource "aws_iam_role_policy_attachment" "internet_submit_instance_role_secretsmanager_policy" {
  role       = aws_iam_role.internet_submit_instance_role.id
