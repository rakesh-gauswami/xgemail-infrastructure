...
resource "aws_iam_role_policy_attachment" "mf_inbound_delivery_instance_role_cloudwatch_policy" {
...
resource "aws_iam_role_policy_attachment" "mf_inbound_delivery_instance_role_ssm_agent_policy" {
  role       = aws_iam_role.mf_inbound_delivery_instance_role.id
  policy_arn = aws_iam_policy.ssm_agent_policy.arn
}

resource "aws_iam_role_policy_attachment" "mf_inbound_delivery_instance_role_asg_policy" {
  role       = aws_iam_role.mf_inbound_delivery_instance_role.id
  policy_arn = aws_iam_policy.asg_policy.arn
}

resource "aws_iam_role_policy_attachment" "mf_inbound_delivery_instance_role_ec2_policy" {
  role       = aws_iam_role.mf_inbound_delivery_instance_role.id
  policy_arn = aws_iam_policy.ec2_policy.arn
}

resource "aws_iam_role_policy_attachment" "mf_inbound_delivery_instance_role_sns_policy" {
  role       = aws_iam_role.mf_inbound_delivery_instance_role.id
  policy_arn = aws_iam_policy.sns_policy.arn
}

resource "aws_iam_role_policy_attachment" "mf_inbound_delivery_instance_role_secretsmanager_policy" {
  role       = aws_iam_role.mf_inbound_delivery_instance_role.id
