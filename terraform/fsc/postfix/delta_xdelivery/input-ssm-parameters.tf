locals {
  ...
  input_param_sg_delta_delivery_ec2_id        = nonsensitive(data.aws_ssm_parameter.sg_delta_delivery_ec2_id.value)
...
data "aws_ssm_parameter" "sg_delta_delivery_ec2_id" {
  provider = aws.parameters
