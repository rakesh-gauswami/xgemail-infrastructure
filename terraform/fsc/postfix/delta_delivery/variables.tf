...
variable "delta_delivery_sqs_queue_name" {
  type        = string
  description = "delta_delivery_sqs_queue_name"
}

variable "delta_delivery_sqs_queue_url" {
  type        = string
  description = "delta_delivery_sqs_queue_url"
}
