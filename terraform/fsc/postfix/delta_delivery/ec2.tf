...
resource "aws_cloudformation_stack" "cloudformation_stack" {
  name = "delta-delivery"
  template_body = "${file("${path.module}/templates/as-delta-delivery-template.json")}"
  parameters = {
    AesDecryptionKey                  =                     "NO"
    ...
    VpcName                           = "email"
    XgemailBucketName                 = var.delta_delivery_bucket cross
    ...
    XgemailQueueUrl                   = var.delta_delivery_sqs_queue cross
