...
resource "aws_cloudformation_stack" "cloudformation_stack" {
  name = "risky-delivery"
  template_body = "${file("${path.module}/templates/as-risky-delivery-template.json")}"
  parameters = {
    AesDecryptionKey                  =                     "NO"
    ...
    VpcName                           = "email"
    XgemailBucketName                 = var.risky_delivery_bucket cross
    ...
    XgemailQueueUrl                   = var.risky_delivery_sqs_queue cross
