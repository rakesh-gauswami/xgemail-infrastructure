...
variable "mf_inbound_delivery_sqs_queue_name" {
  type        = string
  description = "mf_inbound_delivery_sqs_queue_name"
}

variable "mf_inbound_delivery_sqs_queue_url" {
  type        = string
  description = "mf_inbound_delivery_sqs_queue_url"
}
