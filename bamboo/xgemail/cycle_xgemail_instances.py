...
def parse_command_line():
    ...
    parser.add_argument("--itype", "-i", dest='itype', choices=['submit', 'delivery', 'xdelivery', 'customer-submit', 'internet-delivery', 'internet-xdelivery', 'encryption-delivery', 'encryption-submit', 'internet-risky-delivery'], help="Enter the Instance type.")
