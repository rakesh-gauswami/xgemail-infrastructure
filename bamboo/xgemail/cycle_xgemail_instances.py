...
def parse_command_line():
    ...
    parser.add_argument("--itype", "-i", dest='itype', choices=['xdelivery', 'internet-xdelivery', 'risky-xdelivery', 'warmup-xdelivery', 'beta-xdelivery'], help="Enter the Instance type.")
