...
if __name__ == '__main__':
    ...
    if args.account == 'prod':
        if args.region == 'us-west-2':
            blocks = ['34.212.96.64/26', '34.213.30.0/26', '34.213.30.64/26', '34.213.30.128/26']
        if args.region == 'eu-west-1':
            blocks = ['34.253.219.128/26', '34.253.219.192/26', '34.253.238.0/26', '34.253.238.64/26']
        if args.region == 'eu-central-1':
            blocks = ['35.159.27.0/26', '35.159.27.64/26', '35.159.27.128/26', '35.159.27.192/26']
        if args.region == 'us-east-2':
            blocks = ['18.216.13.64/26', '18.216.13.128/26', '18.216.13.192/26', '18.216.23.0/26']
