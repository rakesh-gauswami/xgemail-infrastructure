...
PIPELINES = [
    ...
    ('internet-submit-deploy',          'internetSubmitDeployPipeline.groovy',          CRON),
    ('customer-delivery-deploy',        'customerDeliveryDeployPipeline.groovy',        CRON),
    ('customer-xdelivery-deploy',       'customerXdeliveryDeployPipeline.groovy',       CRON),
    ('customer-submit-deploy',          'customerSubmitDeployPipeline.groovy',          CRON),
    ('internet-delivery-deploy',        'internetDeliveryDeployPipeline.groovy',        CRON),
    ('internet-xdelivery-deploy',       'internetXdeliveryDeployPipeline.groovy',       CRON),
    ('risky-delivery-deploy',           'riskyDeliveryDeployPipeline.groovy',           CRON),
    ('risky-xdelivery-deploy',          'riskyXdeliveryDeployPipeline.groovy',          CRON),
    ('warmup-delivery-deploy',          'warmupDeliveryDeployPipeline.groovy',          CRON),
    ('warmup-xdelivery-deploy',         'warmupXdeliveryDeployPipeline.groovy',         CRON),
    ('delta-delivery-deploy',           'deltaDeliveryDeployPipeline.groovy',           CRON),
    ('delta-xdelivery-deploy',          'deltaXdeliveryDeployPipeline.groovy',          CRON),
    ('encryption-submit-deploy',        'encryptionSubmitDeployPipeline.groovy',        CRON),
    ('encryption-delivery-deploy',      'encryptionDeliveryDeployPipeline.groovy',      CRON),
    ('mfr-inbound-submit-deploy',       'mfrInboundSubmitDeployPipeline.groovy',        CRON),
    ('mfr-inbound-delivery-deploy',     'mfrInboundDeliveryDeployPipeline.groovy',      CRON),
    ('mfr-inbound-xdelivery-deploy',    'mfrInboundXdeliveryDeployPipeline.groovy',     CRON),
    ('mfr-outbound-submit-deploy',      'mfrOutboundSubmitDeployPipeline.groovy',       CRON),
    ('mfr-outbound-delivery-deploy',    'mfrOutboundDeliveryDeployPipeline.groovy',     CRON),
    ('mfr-outbound-xdelivery-deploy',   'mfrOutboundXdeliveryDeployPipeline.groovy',    CRON)
]
