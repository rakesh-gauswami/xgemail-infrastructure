...
PIPELINES = [
    ...
    ('outbound-submit-deploy',          'outboundSubmitDeployPipeline.groovy',          CRON),
    ('outbound-delivery-deploy',        'outboundDeliveryDeployPipeline.groovy',        CRON),
    ('outbound-xdelivery-deploy',       'outboundXdeliveryDeployPipeline.groovy',       CRON),
    ...
    ('beta-delivery-deploy',            'betaDeliveryDeployPipeline.groovy',            CRON),
    ('beta-xdelivery-deploy',           'betaXdeliveryDeployPipeline.groovy',           CRON),
