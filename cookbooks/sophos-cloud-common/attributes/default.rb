...
# Added as default so that other instances won't be affected
default['sophos_cloud_common']['configure_logstash_forwarder']['wildfly_logs'] = 'False'
default['sophos_cloud_common']['configure_logstash_forwarder']['wildfly_log_path'] = '/data/log/wildfly/*.log'
default['sophos_cloud_common']['configure_logstash_forwarder']['wildfly_log_type'] = 'smc-wildfly'
