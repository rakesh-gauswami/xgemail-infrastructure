...
# Recipe:: setup_xgemail_journal_sqs_message_producer
#
...
include_recipe 'sophos-cloud-xgemail::setup_xgemail_journal_sqs_message_processors_structure'
...
if NODE_TYPE == JOURNAL_SUBMIT
  XGEMAIL_SUBMIT_TYPE = 'JOURNAL'
else
