...
# Recipe:: configure-bounce-message-delivery-queue
#
...
# warmup delivery and extended warmup delivery postfix instance
#
...
WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_DIR = node['xgemail']['warmup_delivery_message_bouncer_processor_dir']
WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR  = node['xgemail']['warmup_delivery_message_bouncer_common_dir']

BOUNCE_HANDLER_SCRIPT = 'xgemail.message.bouncer.py'
NOTIFICATION_EVENT_FILE_NAME = 'notificationsubmitinfo.py'
BOUNCE_HANDLER_SCRIPT_PATH = "#{WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_DIR}/#{BOUNCE_HANDLER_SCRIPT}"
...
if NODE_TYPE == 'warmup-delivery' || NODE_TYPE == 'warmup-xdelivery'
 ...
 SERVICE_TYPE='unix'
 BOUNCE_USER=node['xgemail']['warmup_delivery_bounce_message_processor_user']
 ...
 directory WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_DIR do
   owner BOUNCE_USER
   group BOUNCE_USER
   mode '0755'
   recursive true
 ...
 # Create directory for bounce-handler script
 directory WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR do
   owner 'root'
   group 'root'
   mode '0755'
   recursive true
 ...
 file "#{WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR}/__init__.py" do
   mode '0644'
   owner 'root'
   group 'root'
 end
 ...
 cookbook_file "#{WARMUP_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR}/#{NOTIFICATION_EVENT_FILE_NAME}" do
