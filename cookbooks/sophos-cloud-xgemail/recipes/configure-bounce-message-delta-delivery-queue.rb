...
# delta delivery and extended delta delivery postfix instance
#
...
DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_DIR = node['xgemail']['delta_delivery_message_bouncer_processor_dir']
DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR  = node['xgemail']['delta_delivery_message_bouncer_common_dir']

BOUNCE_HANDLER_SCRIPT = 'xgemail.message.bouncer.py'
NOTIFICATION_EVENT_FILE_NAME = 'notificationsubmitinfo.py'
BOUNCE_HANDLER_SCRIPT_PATH = "#{DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_DIR}/#{BOUNCE_HANDLER_SCRIPT}"
...
if NODE_TYPE == 'delta-delivery' || NODE_TYPE == 'delta-xdelivery'
 ...
 SERVICE_TYPE='unix'
 BOUNCE_USER=node['xgemail']['delta_delivery_bounce_message_processor_user']
 ...
 directory DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_DIR do
   owner BOUNCE_USER
   group BOUNCE_USER
   mode '0755'
   recursive true
 ...
 # Create directory for bounce-handler script
 directory DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR do
   owner 'root'
   group 'root'
   mode '0755'
   recursive true
 ...
 file "#{DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR}/__init__.py" do
   mode '0644'
   owner 'root'
   group 'root'
 end
 ...
 cookbook_file "#{DELTA_DELIVERY_BOUNCE_MESSAGE_PROCESSOR_COMMON_DIR}/#{NOTIFICATION_EVENT_FILE_NAME}" do
