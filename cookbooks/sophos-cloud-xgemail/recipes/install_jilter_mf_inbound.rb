...
# Recipe:: install_mf_jilter_inbound
#
# Copyright 2021, Sophos
#
# All rights reserved - Do Not Redistribute
#
# Configure Xgemail Jilter service for mf inbound email processing
#
...
JILTER_PACKAGE_NAME = 'xgemail-jilter-mf-inbound'
...
if ACCOUNT == 'sandbox'
  include_recipe 'sophos-cloud-xgemail::install_jilter_mf_code_sandbox'
...
template 'xgemail.jilter.properties' do
  ...
  source 'jilter-mf-inbound-application.properties.erb'
  mode '0700'
  owner SERVICE_USER
  group SERVICE_USER
  variables(
...
if ACCOUNT != 'sandbox'
  ...
  template 'xgemail.jilter.service.sh' do
    ...
    source 'xgemail.jilter.mf.inbound.service.sh.erb'
    mode '0700'
    owner SERVICE_USER
    group SERVICE_USER
    variables(
  ...
  template "launch_darkly_sandbox.properties" do
    path "#{DEPLOYMENT_DIR}/xgemail-jilter-mf-#{DIRECTION}/conf/launch_darkly_sandbox.properties"
