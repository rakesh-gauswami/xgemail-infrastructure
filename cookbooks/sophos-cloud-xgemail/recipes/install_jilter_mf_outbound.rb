...
# Recipe:: install_jilter_mf_outbound
#
# Copyright 2021, Sophos
#
# All rights reserved - Do Not Redistribute
#
# Configure Xgemail Jilter service for mf outbound email processing
#
...
JILTER_PACKAGE_NAME = 'xgemail-jilter-mf-outbound'
...
src = "#{DEPLOYMENT_DIR}/xgemail-jilter-mf-inbound/lib/libdkimjni-#{LIBDKIM_JNI_VERSION}.so"
...
if ACCOUNT != 'sandbox'
  ...
  template 'xgemail.jilter.properties' do
    ...
    source 'jilter-mf-outbound-application.properties.erb'
    mode '0700'
    owner SERVICE_USER
    group SERVICE_USER
    variables(
