...
# Recipe:: setup_submit_flat_file_flag_based_rollout
#
...
if NODE_TYPE != 'internet-submit' && NODE_TYPE != 'mf-inbound-submit' && NODE_TYPE != 'journal-submit'
    return
end
...
TOGGLE_FLAT_FILE_SCRIPT      = 'inbound.submit.flat.file.flag.based.rollout.py'
TOGGLE_FLAT_FILE_SCRIPT_PATH = "#{PACKAGE_DIR}/#{TOGGLE_FLAT_FILE_SCRIPT}"

#directory for internet submit services
