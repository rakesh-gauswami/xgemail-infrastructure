...
# Only continue when it's customer-submit or internet-submit or mfr-internet-submit
if NODE_TYPE != 'customer-submit' and NODE_TYPE != 'internet-submit' and NODE_TYPE != 'mfr-internet-submit'
  return
end
...
# Write block list script to customer-submit and internet-submit and mfr-internet-submit instances
