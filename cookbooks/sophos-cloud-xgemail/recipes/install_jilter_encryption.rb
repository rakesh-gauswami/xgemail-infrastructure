...
MSG_HISTORY_STREAM_NAME = node['xgemail']['msg_history_v2_stream_name']
...
MSG_HISTORY_DYNAMODB_TABLE_NAME = node['xgemail']['msg_history_v2_dynamodb_table_name']
...
template 'xgemail.jilter.properties' do
  ...
  variables(
      ...
      :node_ip => NODE_IP,
      :msg_history_v2_stream_name => MSG_HISTORY_STREAM_NAME,
      :msg_history_v2_bucket_name => MSG_HISTORY_FAILURE_BUCKET_NAME,
      :msg_history_event_dir => MSG_HISTORY_EVENT_DIR,
      :msg_history_v2_dynamodb_table_name =>  MSG_HISTORY_DYNAMODB_TABLE_NAME        
  )
end
