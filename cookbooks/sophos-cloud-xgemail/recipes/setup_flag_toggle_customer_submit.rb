...
METADATA_FROM_MSGHISTORY_TOGGLE_SCRIPT_PATH = "#{GENERAL_USER_BASED_SPLIT_PACKAGE_DIR}/#{GENERAL_USER_BASED_SPLIT_TOGGLE_SCRIPT_NAME}"
...
template METADATA_FROM_MSGHISTORY_TOGGLE_SCRIPT_PATH do
  source "#{METADATA_FROM_MSGHISTORY_TOGGLE_SCRIPT_PATH}.erb"
  mode '0750'
  owner 'root'
  group 'root'
  variables(
