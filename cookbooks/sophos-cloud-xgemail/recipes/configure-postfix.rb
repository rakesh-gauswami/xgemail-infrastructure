...
if NODE_TYPE == 'customer-delivery' || NODE_TYPE == 'mfr-customer-delivery' || NODE_TYPE == 'internet-delivery' || NODE_TYPE == 'encryption-delivery' || NODE_TYPE == 'risky-delivery' || NODE_TYPE == 'warmup-delivery' || NODE_TYPE == 'beta-delivery' || NODE_TYPE == 'delta-delivery'
  MANAGED_SERVICES_IN_START_ORDER = [
  'postfix'
]
else
