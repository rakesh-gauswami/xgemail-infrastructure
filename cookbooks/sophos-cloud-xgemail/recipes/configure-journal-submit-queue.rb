...
if ACCOUNT != 'sandbox'
  ...
  include_recipe 'sophos-cloud-xgemail::setup_internet_submit_dynamodb_domain_verification'
  include_recipe 'sophos-cloud-xgemail::setup_xgemail_journal_sqs_message_producer'
  include_recipe 'sophos-cloud-xgemail::setup_xgemail_journal_multi_policy_service'
