...
# Recipe:: setup_mf_inbound_submit_domain_updater_cron
#
...
CRON_MINUTE_FREQUENCY = node['xgemail']['mf_inbound_submit_domain_cron_minute_frequency']
...
CRON_SCRIPT           = 'mf.inbound.submit.domain.updater.py'
