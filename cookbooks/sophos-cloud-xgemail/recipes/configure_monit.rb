...
template '/etc/monit.d/transport-updater.conf' do
  ...
  owner 'root'
  group 'root'
  only_if { NODE_TYPE == 'xdelivery' || NODE_TYPE == 'customer-delivery' || NODE_TYPE == 'mf-inbound-xdelivery' || NODE_TYPE == 'mf-outbound-xdelivery' || NODE_TYPE == 'mf-inbound-xdelivery' || NODE_TYPE == 'mf-outbound-xdelivery'}
end
