...
class GetPrefixRestructureConfig:
    """
    Contains configuration that determines if 'S3 prefix' changes is enabled.
    ...
    def is_prefix_messages_path_enabled(self, customer_id, submit_server_ip):
        """
